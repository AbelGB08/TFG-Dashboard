...
class INA226:
    ...
    def __write_register(self, register, register_value):
        ...
        #self.logger.debug("write register 0x%02x: 0x%04x 0b%s" %  (register, register_value, binary_as_string(register_value)))
    ...
    def __read_register(self, register, negative_value_supported=False):
        ...
        #self.logger.debug(            "read register 0x%02x: 0x%04x 0b%s" %            (register, register_value, binary_as_string(register_value)))
